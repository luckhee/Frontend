...
export const patentAPI = {
  // 최근 등록된 특허 목록 조회
  getRecentPatents: async (): Promise<
    Array<{
      id: number;
      title: string;
      description: string;
  ...
  // 인기 특허 목록 조회
  getPopularPatents: async (): Promise<
    Array<{
      id: number;
      title: string;
      description: string;
...
export const memberAPI = {
  ...
  verifyMember: async (data: {
    ...
    const response = await fetch(
      `${apiClient.defaults.baseURL}/api/members/verify-member`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  findAndUpdatePassword: async (data: {
    ...
    const response = await fetch(
      `${apiClient.defaults.baseURL}/api/members/find-password`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
